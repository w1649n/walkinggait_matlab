for time = 0 : sample_time_ : 2 * period_t_ - sample_time_
    ...
    switch walking_state
        case "first"
            ...
            Cvy0(k) = Com_vely0(0, base_y + com_y_swing, zmp_y, period_t_, Tc_);
        ...
        case "stop"
            ...
            Cvy0(k) = Com_vely0(last_base_y + com_y_swing, base_y, zmp_y, period_t_, Tc_);
            Cpy(k) = Com_posy(last_base_y + com_y_swing, Cvy0(k), zmp_y, t_, Tc_);
